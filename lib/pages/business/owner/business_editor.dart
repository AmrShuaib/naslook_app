    ...
    return Scaffold(
      ...
      body: ListView(padding: const EdgeInsets.fromLTRB(20, 8, 20, 32), children: [
        ...
        JoyCard(child: Column(children: [
          ...
          const SizedBox(height: 10),
          TextField(controller: sector, decoration: InputDecoration(labelText: 'القطاع', hintText: switch (category) { BizCategory.brand => 'مقهى، أزياء، إلكترونيات…', BizCategory.cinema => 'سينما', BizCategory.hotel => 'فندق 4 نجوم', BizCategory.carRental => 'تأجير سيارات', BizCategory.hospital => 'مستشفى عام', BizCategory.airport => 'مطار دولي', BizCategory.cafe => 'قهوة مختصة', BizCategory.restaurant => 'وجبات سريعة، مشويات…', BizCategory.company => 'صناعة، اتصالات، خدمات…', BizCategory.university => 'جامعة حكومية أو أهلية' })),
          const SizedBox(height: 10),
