                  ...
                  for (final o in pr.offerings)
                    Padding(
                      ...
                      child: JoyCard(child: Row(children: [
                        if (o.imageUrl != null && o.imageUrl!.isNotEmpty) ClipRRect(borderRadius: BorderRadius.circular(10), child: Image.network(o.imageUrl!, width: 52, height: 52, fit: BoxFit.cover, errorBuilder: (_, __, ___) => const SizedBox(width: 52, height: 52))) else const Icon(Icons.local_offer_outlined, color: Joy.primary),
