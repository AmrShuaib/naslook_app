...
**قرار مطلوب منك (تمويل المحفظة في iOS)**: الشحن مخفي في نسخة iOS، فالمستخدم الجديد على الآيفون لا يستطيع الشراء إلا برصيد شحنه من الويب. للمراجِع يكفي حساب مشحون من الإدارة. للإطلاق الفعلي يوجد خياران: السماح بالدفع بالبطاقة عبر ميسر في iOS للسلع المادية والخدمات فقط (تسمح به أبل وفق 3.1.3(e))، أو الدفع لكل طلب عبر بوابة مرخّصة كما في المسار التنظيمي الموصى به.
